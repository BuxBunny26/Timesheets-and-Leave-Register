    ...
    return (
      <div className="min-h-screen bg-[var(--surface-secondary)] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-[var(--surface)] py-8 px-6 shadow-sm border border-[var(--border)] rounded-xl text-center space-y-4">
            ...
            <p className="text-sm text-[var(--text-muted)]">Your password has been changed successfully.</p>
            <button
              onClick={() => navigate('/')}
  ...
  return (
    <div className="min-h-screen bg-[var(--surface-secondary)] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-5 text-center text-2xl font-bold tracking-tight text-[var(--text-primary)]">Set new password</h2>
        <p className="mt-1 text-center text-sm text-[var(--text-muted)]">Must be at least 8 characters</p>
      </div>
