...
export default function AwolReport() {
  ...
  async function runReport() {
    ...
    setRows((data ?? []).map((d: unknown) => {
      const day = d as { date: string; day_of_week: string; timesheet_week: { employee: { first_name: string; surname: string; employee_code: string | null; site: { name: string } | null } } }
      return {
